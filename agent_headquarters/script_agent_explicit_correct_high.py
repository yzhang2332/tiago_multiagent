...
# Upload JSON script to a vector store
script_vector_store = client.beta.vector_stores.create(name="script_context")

client.beta.vector_stores.file_batches.upload_and_poll(
    vector_store_id=script_vector_store.id,
    files=[
...
# Create ScriptAgent
script_agent = client.beta.assistants.create(
    name="ScriptAgent",
    instructions="""
...
client.beta.assistants.update(
    assistant_id=script_agent.id,
    tool_resources={
        "file_search": {
            "vector_store_ids": [script_vector_store.id]
        }
    }
)

print("ScriptAgent created:", script_agent.id)